  ...
  return (
    <>
      ...
      <section className="relative min-h-[340px] py-24 px-4 flex items-center overflow-hidden">
        <img src="/heroes/contact-hero.webp" alt="" aria-hidden="true" fetchPriority="high" loading="eager" decoding="sync" width="1600" height="900" className="absolute inset-0 w-full h-full object-cover" />
